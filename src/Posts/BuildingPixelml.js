...
export default class BuildingPixelml extends Component {
       ...
       <div className="content content-home">
        <br/>
          <div className="content-text">
            ...
            <h5 style={{ textAlign: "center"}}><b>Here are some of the biggest problems and outcomes I have faced </b>(In order)</h5>
            ...
            <h5> First version: </h5>
            <figure>
              <img className="ui centered image" src="https://puu.sh/v4ki2/2e10b41c48.jpg"/>
              <figcaption>
            ...
            <img className="ui centered image" src="https://puu.sh/vJDZt/143f303e9c.png"/>
            <h5> What I learned: </h5>
            <ul>
            ...
            <p>
              ...
              <img className="ui centered image" src="https://puu.sh/vCo6q/0608208025.png"/>
              <img className="ui centered image"src="https://puu.sh/vDvKK/f913e20b88.png" />
              <img className="ui centered image"src="https://puu.sh/vDAj6/06f8a7012c.png"/>
              <img className="ui centered image"src="https://puu.sh/vFAwu/e28a6faf5c.png" />
              <img className="ui centered image"src="https://puu.sh/vKo27/0ce09382de.png"/>
              <img className="ui centered image"src="https://puu.sh/vMvII/8d973517d3.png" />
              <img className="ui centered image"src="https://puu.sh/vQYsW/02326dc145.png"/>
              <img className="ui centered image"src="https://puu.sh/vQZCL/db4b1105aa.png" />
              <img className="ui centered image"src="https://puu.sh/vQZEN/1e462b3933.png"/>
              <img className="ui centered image" src="https://puu.sh/vTbTB/fcaabd241f.gif" />
            <h5> What I learned: </h5>
            <ul>
            ...
            <p>
              ...
              <img className="ui centered image" src="https://puu.sh/w1yRL/ceab4005b9.png"/>
              <img className="ui centered image" src="https://puu.sh/w1yCQ/a637f9a4c8.gif" />
              <img className="ui centered image"src="https://puu.sh/wbWrA/43812b88d6.png"/>
              <img className="ui centered image"src="https://puu.sh/waiup/695a2d81f3.png" />
              <img className="ui centered image"src="https://puu.sh/wee3p/e5121438ac.png"/>
            <h5> What I learned: </h5>
            <ul>
            ...
            <figure>
              <img className="ui huge centered image" src="https://puu.sh/weExM/4de2d12541.png"/>
              <img className="ui huge centered image"src="https://puu.sh/wedIj/b18da1265d.png" />
              <figcaption>
            ...
            <figure>
              <img className="ui centered huge image" src="https://puu.sh/wiE3p/c56a680fba.png"/>
              <img className="ui centered huge image" src="https://puu.sh/wiFCp/7bbe21edb3.png" />
              <img className="ui centered huge image" src="https://puu.sh/wiGA6/6d1fd7f357.png"/>
              <img className="ui centered huge image" src="https://puu.sh/wiHs6/fda51f570a.png" />
              <img className="ui centered image" src="https://puu.sh/wiHtw/43da58b406.png"/>
              <img className="ui centered huge image" src="https://puu.sh/wk0Zh/0183863488.png" />
              <img className="ui centered image" src="https://puu.sh/wk35h/ae22722402.png"/>
              <img className="ui centered image" src="https://puu.sh/wrvmt/51e8a533e4.png" />
              <img className="ui centered image" src="https://puu.sh/wiIFC/d7a38e952c.gif"/>
              <img className="ui huge centered image" src="https://puu.sh/wTiwg/4861c62d7f.png" />
              <figcaption>
            ...
            <figure>
              <img className="ui centered image" src="https://puu.sh/xyaJe/8d32378f26.png"/>
              <figcaption>
